...
class TestBasePipeline:
    ...
    def test_constructor_with_logger(self):
        ...
        class ConcretePipeline(BasePipeline):
            ...
            def store(self, data, file_path=None): pass
            def load_to_database(self, db_path='test.db'): pass
    ...
    def test_run_full_pipeline_workflow(self):
        ...
        mock_logger.info.assert_any_call("ConcretePipeline pipeline completed successfully!")
...
class TestBaseProcessor:
    ...
    def test_save_to_file_with_config_path(self):
        ...
        mock_config_manager.get_configuration_by_table.assert_called_once_with("test_table")
    ...
    def test_save_to_file_no_config_found(self):
        ...
        with pytest.raises(ValueError, match="No configuration found for test_table table"):
            processor.save_to_file(test_data)
...
class TestBaseStorage:
    ...
    def test_load_to_database_no_config_found(self):
        ...
        class ConcreteStorage(BaseStorage):
            def create_table(self, conn): pass  # pragma: no cover
            def insert_data(self, conn, data_file_path): return 0  # pragma: no cover
