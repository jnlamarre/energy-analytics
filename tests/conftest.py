    ...
    return {
        ...
        "stations_table": {
            ...
            "expected_data": [
                ...
                (2, 45.7640, 4.8357, "Lyon"),
                (3, 43.2965, 5.3698, "Marseille"),
            ],
        },
    }
...
def mock_api_success_response():
    ...
    return {"data": [{"id": 1, "value": "test"}], "links": {"next": None}}
...
def mocked_configuration_manager():
    ...
    class MockedConfigManager:
        def __init__(self):
            ...
            self.original_get_by_type = (
                ConfigurationManager.get_configurations_by_api_type
            )
